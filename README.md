# MSTeams Apps UserSignIn - Microsoft Teams App
...
3. Create a new *Web App* with Windows App Service Plan and give it the name of your tab, the same you used when asked for URL in the Yeoman generator. In your case https://3baf1be876ad.ngrok.io.
...
13. Wait until the deployment is completed and navigate to https://3baf1be876ad.ngrok.io/privacy.html to test that the web application is running
14. Done
