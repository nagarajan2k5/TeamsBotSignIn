...
3. Give the bot a handle (ex: `userSignInBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://3baf1be876ad.ngrok.io/api/messages`
